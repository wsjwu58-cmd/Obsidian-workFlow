# Claude Code v2.1.224 — self-hosted environments

- **标题：** Claude Code v2.1.224 — self-hosted environments
- **来源：** https://github.com/anthropics/claude-code/releases/tag/v2.1.224
- **发布：** 2026-08-07T04:00:59Z（GitHub release，正式版，作者 ashwin-ant）
- **性质：** Claude Code 桌面版/CLI 版本发布说明（短篇变更日志；正文 Markdown 约 4.7KB，31 条变更）
- **抓取：** 2026-08-17（GitHub Releases API `releases/tags/v2.1.224` 获取 markdown body，并已与 release 页面 HTML 交叉核对一致；发布说明无外链，代码标识符以行内代码保留）
