# langgenius/dify — Build Agentic workflows, RAG pipelines, with rich AI model and tool support on one collaborative works

- **标题：** langgenius/dify — Build Agentic workflows, RAG pipelines, with rich AI model and tool support on one collaborative workspace
- **来源：** https://github.com/langgenius/dify
- **发布：** 仓库创建于 2023-04-12；本 README 采集于 2026-09-12（`main` 分支）
- **性质：** 开源仓库主 README（英文正文 Markdown 约 12KB；含仓库状态徽章、语言切换导航与站点链接）
- **抓取：** 2026-09-12，GitHub API `repos/langgenius/dify/readme`（`Accept: application/vnd.github.raw+json`）取得正文，并与 firecrawl 抓取的仓库页面主内容交叉核对；仓库另存 `docs/zh-CN/README.md` 官方简体中文版（结构与英文版略有出入，本次只作术语对照，不据此改动原文）
- **仓库指标（2026-09-12）：** stars 155,457 / forks 24,552 / open issues 1,067；主语言 TypeScript；topics 含 agent、agentic-ai、agentic-framework、agentic-workflow、llm、low-code、mcp、workflow、rag、openai、claude、deepseek 等
