...
- **发布：** 仓库创建于 2022-10-17；本 README 采集于 2026-09-12（`master` 分支，最后推送 2026-09-11）
- **性质：** 开源仓库主 README（英文正文 Markdown 约 5.9KB；含 logo/徽章 HTML、快速开始、生态清单与「为什么用 LangChain」六点）
- **抓取：** 2026-09-12，GitHub API `repos/langchain-ai/langchain/readme`（`Accept: application/vnd.github.raw+json`）取得权威正文；仓库元数据取自 GitHub API `repos/langchain-ai/langchain`，并与 firecrawl 抓取的仓库页面主内容交叉核对
- **仓库指标（2026-09-12）：** stars 146,137 / forks 24,416 / open issues 486 / watchers（subscribers）919；主语言 Python；LICENSE 为 MIT；topics 含 agents、ai-agents、deepagents、langgraph、llm、multiagent、rag、pydantic、python、typescript 等
- **官方中文版：** 仓库 README 未提供官方简体中文版；译文以英文 `README.md` 为唯一原文
