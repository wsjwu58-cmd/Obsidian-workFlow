# Shubhamsaboo/awesome-llm-apps — 100+ AI Agents, Agent Skills and RAG Apps
...
- **发布：** 仓库创建于 2024-04-29；本 README 采集于 2026-09-12（`main` 分支，最后推送 2026-09-11）
- **性质：** 开源仓库主 README（英文正文 Markdown 约 25KB / 319 行；含 banner 图、6 张画廊缩略图、赞助商位、15 个分类共 117 个模板条目、快速开始命令、多语言链接）
- **抓取：** 2026-09-12，GitHub API `repos/Shubhamsaboo/awesome-llm-apps/readme`（`Accept: application/vnd.github.raw+json`）取得权威正文；仓库元数据取自 GitHub API `repos/Shubhamsaboo/awesome-llm-apps`
- **仓库指标（2026-09-12）：** stars 137,242 / forks 20,194 / open issues 11 / watchers（subscribers）1,286；主语言 Python；license Apache-2.0；homepage https://www.theunwindai.com ；topics 含 agents、llms、python、rag
- **官方中文版：** 仓库内无官方简体中文 `README.md`；README 底部经由 readme-i18n.com 提供 zh 等多语言外部链接，非仓库内官方译文；故本译文以英文 `README.md` 为唯一原文
